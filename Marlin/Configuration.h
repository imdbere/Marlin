...
#define STRING_CONFIG_H_AUTHOR "(imdbere, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_STM32F1VC
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 190, 190, 8.4, 25 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (6.50)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (11.50)    // Y point for Z homing when homing all axes (G28).
#endif
